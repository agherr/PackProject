...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException - if the file can not be read/found
	 */
	 ...
	 * @throws IllegalArgumentException if the two passwords do not match
	 */
	...
	/**
	 * getStudentById searches for a student from a student directory and returns
	 * the student object if the ID matches a corresponding student returns null if
	 * the student does not exist.
	 * 
	 * @param id - the ID of the student to locate in the studentDirectory
	 * @return the student object of the student with corresponding ID (null if the
	...
	public Student getStudentById(String id) {
		...
		//no corresponding student return null.
		return null;
	}
}

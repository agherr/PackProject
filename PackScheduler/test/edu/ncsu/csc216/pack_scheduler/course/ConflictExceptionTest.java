...
/**
 * ConflictExceptionTest tests the construction of a ConflictException used in WolfScheduler.java
 * Test checks that a ConflictException has the correct default message of 
 * 
 * 
 * @author Ashten
 */
